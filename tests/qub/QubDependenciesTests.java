    ...
    static void test(TestRunner runner)
    {
        ...
        runner.testGroup(QubDependencies.class, () ->
        {
            runner.testGroup("main(String[])", () ->
            {
                ...
                {
                    test.assertThrows(() -> QubDependencies.main((String[])null),
            ...
            runner.testGroup("getParameters(Process)", () ->
            {
                runner.test("with null", (Test test) ->
                {
                    test.assertThrows(() -> QubDependencies.getParameters(null),
                ...
                runner.test("with no arguments", (Test test) ->
                {
                    try (final Process process = Process.create())
                    {
                        ...
                        final QubDependenciesParameters parameters = QubDependencies.getParameters(process);
                ...
                runner.test("with -?", (Test test) ->
                {
                    try (final Process process = Process.create("-?"))
                    {
                        ...
                        test.assertEqual(
                            Iterable.create(
                                "Usage: qub-dependencies [--profiler] [--verbose] [--help]",
            ...
            runner.testGroup("run(QubDependenciesParameters)", () ->
            {
                ...
                runner.test("with non-existing folder", (Test test) ->
                {
                    ...
                    test.assertEqual(1, QubDependencies.run(parameters));
                ...
                runner.test("with project.json with no dependencies property", (Test test) ->
                {
                    ...
                    test.assertEqual(0, QubDependencies.run(parameters));
